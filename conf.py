...
html_theme_options = {
    'extra_nav_links': {
        'CV': 'https://github.com/butla/bultrowicz.com/raw/master/cv/cv_Micha%C5%82_Bultrowicz.pdf',
        'Portfolio': 'https://github.com/butla/portfolio',
        'My company': 'https://witchsoft.com',
        'Github': 'https://github.com/butla/',
        'Twitter': 'https://twitter.com/mmmbultrowicz/',
        'LinkedIn': 'https://www.linkedin.com/in/michal-bultrowicz/',
        'Odysee': 'https://odysee.com/@michal.bultrowicz:c',
        'YouTube': 'https://www.youtube.com/@butla/videos',
        'Instagram': 'https://www.instagram.com/mmmbultrowicz/',
